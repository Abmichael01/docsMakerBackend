...
# After depends, only grayscale and track_ are allowed (track_ is checked separately).
ALLOWED_AFTER = {
    ...
    "gen_rule":     ["gen"],
    "mode":         ["gen"],
    "grayscale":    ["upload", "file", "depends"],  # Core rule: grayscale after depends is valid
